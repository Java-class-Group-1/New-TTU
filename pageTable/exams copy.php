...
<div class="page-wrapper">
    ...
    <div class="container-fluid">
      <div class="card">
        ...
        $Course = fetchDepartmentData(); // Assuming fetchFacultyData is a function in fetch_data.php

        foreach ($Course as $Courses) {
            echo "<option value='{$Courses['id']}'>{$Courses['depart_name']}</option>";
        }
