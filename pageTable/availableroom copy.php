...
<div class="page-wrapper">
    ...
    <div class="container-fluid">
      <div class="card">
        ...
        <h1 class="text-center btn-info">Available Rooms Left</h1>
        ...
        $loc = fetchRoomData(); // Assuming fetchFacultyData is a function in fetch_data.php

        foreach ($loc as $locs) {
            echo "<option value='{$locs['location']}'>{$locs['room_name']} - {$locs['location']}</option>";
        }
