        ...
        <div class="page-breadcrumb">
         ...
         <div class="container-fluid">
              ...
              <div class="card">
                ...
                <h2 class="text-right "><i class="mdi mdi-account-key"><a href="../page/program.php" class="text-decoration-none text-danger text-right align-items-center"></i
                  >Add Program or Course</a></h2>
...
$(document).ready(function() {
    ...
    function fetchAndDisplayData() {
        $.ajax({
            type: "GET",
            url: "../functions/fetch_data.php?action=fetchprogramTable",
